...
\end{figure}
    ...
    The following plot indicates the attitude quaternion of the PocketQube. The selected quaternion is the
    one representing the rotation from the Local Vertical Local Horizontal (LVLH) frame to the body frame.
...
\subsubsection{Nadir pointing using an External Kalman Filter for attitude determination}
...
\begin{itemize}
    ...
    \item \textbf{Attitude quaternion}\\
    In this section the attitude quaternion of the PocketQube estimated by the EKF is presented. A comparative between the 
